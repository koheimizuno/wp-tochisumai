...
?>
  ...
  <div class="bg_fixed_wrap">
    <div class="bg_fixed">
      <video playsinline autoplay muted loop data-src="<?php echo get_stylesheet_directory_uri(); ?>/movie/movie.mp4">
      </video>
    </div>
  </div>
  ...
  <li class="item">
    <div class="js-parallax itemImg item01 lazyload"
      style="background: url('<?php echo get_stylesheet_directory_uri(); ?>/img/top/fv_bg1.webp') center center no-repeat; background-size: cover;"></div>
  </li>
  <li class="item">
    <div class="js-parallax itemImg item02 lazyload"
      style="background: url('<?php echo get_stylesheet_directory_uri(); ?>/img/top/fv_bg2.webp') center center no-repeat; background-size: cover;"></div>
  </li>
  <li class="item">
    <div class="js-parallax itemImg item03 lazyload"
      style="background: url('<?php echo get_stylesheet_directory_uri(); ?>/img/top/fv_bg3.webp') center center no-repeat; background-size: cover;"></div>
  </li>
  <li class="item">
    <div class="js-parallax itemImg item04 lazyload"
      style="background: url('<?php echo get_stylesheet_directory_uri(); ?>/img/top/fv_bg4.webp') center center no-repeat; background-size: cover;"></div>
  </li>
  <li class="item">
    <div class="js-parallax itemImg item05 lazyload"
      style="background: url('<?php echo get_stylesheet_directory_uri(); ?>/img/top/fv_bg5.webp') center center no-repeat; background-size: cover;"></div>
  </li>
</div>

    <div class="container">
      <!-- <h1 class="fv_text_main"><span class="big">粋</span>と<span class="big">共</span>に、 <br><span class="big">粋</span>にくらす。</h1> -->
      <h1 class="fv_text_main"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/fv_text.webp" alt=""></h1>
    ...
    <div class="enjoy_container">
      <div class="enjoy_wrap1 flex">
        <div class="enjoy_text_wrap loop1">
          <a tabindex="-1" class="enjoy_text enjoy_text1">陰翳礼讃の<br>美意識</a>
          <a tabindex="-1" class="enjoy_text enjoy_text2">日本文学にみる<br>「明るさ」の定義</a>
          <a tabindex="-1" class="enjoy_text enjoy_text3">大和比 白銀比</a>
          <a tabindex="-1" class="enjoy_text enjoy_text4">濡縁(ぬれえん)に腰掛け<br>庭を眺める</a>
          <a tabindex="-1" class="enjoy_text enjoy_text5">自然との<br>調和を尊し</a>
          <a tabindex="-1" class="enjoy_text enjoy_text6">もののあはれ</a>
          <a tabindex="-1" class="enjoy_text enjoy_text7">日本の四季</a>
          <a tabindex="-1" class="enjoy_text enjoy_text8">光と陰が織りなす風流</a>
          <a tabindex="-1" class="enjoy_text enjoy_text9">「一室一灯」から<br>「多灯分散」へ</a>
          <a tabindex="-1" class="enjoy_text enjoy_text10">幽玄</a>
          <a tabindex="-1" class="enjoy_text enjoy_text11">「内」と「外」を<br>ゆるやかに隔てる</a>
          <a tabindex="-1" class="enjoy_text enjoy_text12">景色を切り取る<br>「借景」</a>
          <a tabindex="-1" class="enjoy_text enjoy_text13">静謐さ</a>
          <a tabindex="-1" class="enjoy_text enjoy_text14">頑丈で強い<br>イメージの石が鎮座する</a>
          <a tabindex="-1" class="enjoy_text enjoy_text15">和庭に静けさ</a>
        </div>
        <div class="enjoy_text_wrap loop1">
          <a tabindex="-1" class="enjoy_text enjoy_text1">陰翳礼讃の<br>美意識</a>
          <a tabindex="-1" class="enjoy_text enjoy_text2">日本文学にみる<br>「明るさ」の定義</a>
      ...
      <div class="enjoy_wrap2 flex">
        <div class="enjoy_text_en_wrap loop2">
          <a tabindex="-1" class="enjoy_text enjoy_text_en1 en">Yamatohi</a>
          <a tabindex="-1" class="enjoy_text enjoy_text_en2 en">Akarusa</a>
          <a tabindex="-1" class="enjoy_text enjoy_text_en3 en">Tatoubunsan</a>
          <a tabindex="-1" class="enjoy_text enjoy_text_en4 en">Uchi to soto</a>
        </div>
        <div class="enjoy_text_en_wrap loop2">
          <a tabindex="-1" class="enjoy_text enjoy_text_en1 en">Yamatohi</a>
          <a tabindex="-1" class="enjoy_text enjoy_text_en2 en">Akarusa</a>
      ...
      <div class="enjoy_wrap3 flex">
        <div class="enjoy_img_wrap loop3">
          <div class="enjoy_img1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img2.webp" alt="粋"></div>
          <div class="enjoy_img2"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img5.webp" alt="粋"></div>
          <div class="enjoy_img3"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img1.webp" alt="粋"></div>
          <div class="enjoy_img4"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img4.webp" alt="粋"></div>
          <div class="enjoy_img5"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img3.webp" alt="粋"></div>
          <div class="enjoy_img6"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img6.webp" alt="粋"></div>
        </div>
        <div class="enjoy_img_wrap loop3">
          <div class="enjoy_img1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img2.webp" alt="粋"></div>
          <div class="enjoy_img2"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/enjoy_img5.webp" alt="粋"></div>
...
<a href="<?php echo esc_url(home_url()); ?>/event/" class="about_btn btn_hover_w">詳しくはこちら</a>
  ...
  <section class="aesthetics about">
    <div class="container">
      <div class="text_wrap flex">
        <h2 class="aesthetics_title">日本の美学を体現する粋の誓い
        </h2>
        <p class="aesthetics_text">
          古来より日本が大切にしてきた感性や美意識。<br>
          その美学は日本に住まう全ての人のＤＮＡに脈々と受け継がれています。<br>
          <br>
            粋ではその受け継がれてきた先人の知恵を和の家に反映すべく、６つの誓いを立てました。<br>          
  ...
  <div class="bg_cover">
    <div class="aesthetics_img1_wrap">
      <div class="aesthetics_img1">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/aesthetics_img1.webp" alt="日本という美学">
      </div>
    </div>
      ...
      <div class="container">
        <div class="container_wide_right">
          <div class="aesthetics_img2">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/aesthetics_img2.webp" alt="日本という美学">
          </div>
        </div>
      </div>
    </div>
    <div class="aesthetics_img3_wrap">
      <div class="aesthetics_img3">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/aesthetics_img3.webp" alt="日本という美学">
      </div>
    </div>
  </div>
  <section class="seasons">
    <div class="seasons_container">
      <div class="seasons_text_wrap">
        <div class="text_wrap">
          <div class="seasons_text_wrap seasons_text_wrap01">
          ...
          <a href="<?php echo esc_url( home_url('/modelhouse/')) ?>" class="seasons_btn">詳細はこちら</a>
        </div>
        <div class="text_wrap">
          <div class="seasons_text_wrap seasons_text_wrap01">
          ...
          <a href="<?php echo esc_url( home_url('/noble_villeage_tsukuba/')) ?>" class="seasons_btn">詳細はこちら</a>
        </div>
        <div class="text_wrap">
          <div class="seasons_text_wrap seasons_text_wrap01">
          ...
          <a href="<?php echo esc_url( home_url('/noble_villeage_mito/')) ?>" class="seasons_btn">詳細はこちら</a>
        </div>
      </div>
      <div class="seasons_img_wrap">
        <div class="seasons_img">
          <figure class="img" data-original="<?php echo get_stylesheet_directory_uri(); ?>/img/top/seasons_bg1.webp" alt="春夏秋冬"></figure>
        </div>
        <div class="seasons_img">
          <figure class="img" data-original="<?php echo get_stylesheet_directory_uri(); ?>/img/top/seasons_bg2.webp" alt="春夏秋冬"></figure>
        </div>
        <div class="seasons_img">
          <figure class="img" data-original="<?php echo get_stylesheet_directory_uri(); ?>/img/top/seasons_bg3.webp" alt="春夏秋冬"></figure>
        </div>
      </div>
    </div>
  </section>
  ...
  <div id="videoModal" class="modal">
          ...
          <div class="modal-content">
              <video id="modalVideo" width="100%" height="100%" controls>
                  <source src="<?php echo get_stylesheet_directory_uri(); ?>/movie/park.mp4" type="video/mp4">
              </video>
          </div>
    </div>
  ...
  <div class="experience">
    <div class="experience_container">
      <div class="movie_wrap">
        <div class="movie">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/modelhouse1.webp" alt="MODEL HOUSE">
        </div>

        
      
        <div class="arrow">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/experience_arrow.webp" alt="再生ボタン">
        </div>
      </div>
      <div class="experience_text_wrap">
        <div class="experience_text_left en">
        Modelhouse
        </div>
        <div class="experience_text_right en">
        Exprience
        </div>
      </div>
      <div class="modelhouse_wrap1">
        <div class="modelhouse_item">
          ...
          <a href="<?php echo esc_url( home_url('/modelhouse/')) ?>" class="btn btn_hover_w">展示場に行ってみる</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modelhouse_wrap modelhouse_wrap2">
    <div class="modelhouse_item fadein">
      <div class="img">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/modelhouse2.webp" alt="MODEL HOUSE">
      </div>
      <h2 class="title">環を描く和の家</h2>
      <p class="text">茨城県つくば市谷田部（陣場）</p>
      <a href="<?php echo esc_url( home_url('/noble_villeage_tsukuba/')) ?>" class="btn btn_hover_w">展示場に行ってみる</a>
    </div>
  </div>
  <div class="modelhouse_wrap modelhouse_wrap3">
    <div class="modelhouse_item fadein">
      <div class="img">
        <a data-fancybox  href="<?php echo get_stylesheet_directory_uri(); ?>/movie/park.mp4">
          <video id="movie_mito" data-src="<?php echo get_stylesheet_directory_uri(); ?>/movie/park.mp4"  autoplay muted playsinline></video>
          <div class="arrow">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/experience_arrow.webp" alt="再生ボタン">
          </div>
        </a>
      ...
      <a href="<?php echo esc_url( home_url('/noble_villeage_mito/')) ?>" class="btn btn_hover_w">展示場に行ってみる</a>
    </div>
  </div>
  </div>
