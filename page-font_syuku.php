...
?>
  ...
  <div class="bg_fixed_wrap">
    <div class="bg_fixed">
      <video autoplay muted loop src="<?php echo get_stylesheet_directory_uri(); ?>/movie/movie.mp4">
      </video>
    </div>
  </div>
...
<a href="<?php echo esc_url(home_url()); ?>/event/" class="about_btn btn_hover_w">詳しくはこちら</a>
      ...
      <div class="seasons_text_wrap">
        <div class="text_wrap">
          <div class="seasons_text_wrap">
            ...
            <h2 class="seasons_title">中庭から光を<br>採り込む家</h2>
        ...
        <div class="text_wrap">
          <div class="seasons_text_wrap">
            ...
            <h2 class="seasons_title">住宅街の中でも<br>静寂を感じられる邸宅</h2>
            <p class="seasons_text">
              住宅街の中で存在感を放つ瓦葺の家。<br>
        ...
        <div class="text_wrap">
          <div class="seasons_text_wrap">
            ...
            <h2 class="seasons_title">日本伝統の<br>照明が映える家</h2>
            <p class="seasons_text">
  ...
  <section class="bg_panel bg_panel1">
    <div class="container">
      <div class="bg_panel_box flex">
        <div class="bg_panel_wrap">
          <div class="panel_item">
            ...
            <a href="#" class="btn btn_hover_w">ご予約ページへ</a>
          </div>
        </div>
        <div class="bg_panel_wrap">
          <div class="panel_item">
            ...
            <a href="#" class="btn btn_hover_w">土地情報ページへ</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="footer_logo_wrap">
          ...
          <div class="footer_logo_btn_wrap">
            <a href="#" class="footer_logo_btn btn btn_hover_w">イベント・見学会はこちら</a>
            <a href="#" class="footer_logo_btn btn btn_hover_w">展示場への来場はこちら</a>
          </div>
        </div>
      </div>
    </div>
